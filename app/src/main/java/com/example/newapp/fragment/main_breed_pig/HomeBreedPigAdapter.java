...
public class HomeBreedPigAdapter extends BaseRecyclerViewAdapter<RecordData, BaseRecyclerViewHolder> {
    private List<RecordData> mDates;
    private Context mContext;
    private GridLayoutManager mGridLayoutManager;

    public HomeBreedPigAdapter(int layoutResId, List<RecordData> dataList, Context context) {

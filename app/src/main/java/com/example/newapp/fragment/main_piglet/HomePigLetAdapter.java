...
public class HomePigLetAdapter extends BaseRecyclerViewAdapter<RecordData, BaseRecyclerViewHolder> {
    private List<RecordData> mDates;
    private Context mContext;
    private GridLayoutManager mGridLayoutManager;

    public HomePigLetAdapter(int layoutResId, List<RecordData> dataList, Context context) {

...
public class GangTieTypeAdapter extends BaseRecyclerViewAdapter<RecordData, BaseRecyclerViewHolder> {
    private List<RecordData> mDates;
    private Context mContext;
    private GridLayoutManager mGridLayoutManager;

    public GangTieTypeAdapter(int layoutResId, List<RecordData> dataList, Context context, GridLayoutManager gridLayoutManager) {

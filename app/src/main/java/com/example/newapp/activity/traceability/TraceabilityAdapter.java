...
public class TraceabilityAdapter extends BaseRecyclerViewAdapter<RecordData, BaseRecyclerViewHolder> {
    private List<RecordData> mDates;
    private Context mContext;
    private GridLayoutManager mGridLayoutManager;

    public TraceabilityAdapter(int layoutResId, List<RecordData> dataList, Context context) {

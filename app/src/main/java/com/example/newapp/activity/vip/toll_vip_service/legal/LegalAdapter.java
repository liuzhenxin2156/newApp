...
public class LegalAdapter extends BaseRecyclerViewAdapter<RecordData, BaseRecyclerViewHolder> {
    private List<RecordData> mDates;
    private Context mContext;
    private GridLayoutManager mGridLayoutManager;

    public LegalAdapter(int layoutResId, List<RecordData> dataList, Context context) {

...
public class PigOlympicsAdapter extends BaseRecyclerViewAdapter<RecordData, BaseRecyclerViewHolder> {
    private List<RecordData> mDates;
    private Context mContext;
    private GridLayoutManager mGridLayoutManager;

    public PigOlympicsAdapter(int layoutResId, List<RecordData> dataList, Context context) {

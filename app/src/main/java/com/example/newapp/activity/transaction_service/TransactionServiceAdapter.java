...
public class TransactionServiceAdapter extends BaseRecyclerViewAdapter<RecordData, BaseRecyclerViewHolder> {
    private List<RecordData> mDates;
    private Context mContext;
    private GridLayoutManager mGridLayoutManager;

    public TransactionServiceAdapter(int layoutResId, List<RecordData> dataList, Context context) {

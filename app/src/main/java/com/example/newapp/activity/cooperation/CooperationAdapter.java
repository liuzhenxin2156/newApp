...
public class CooperationAdapter extends BaseRecyclerViewAdapter<RecordData, BaseRecyclerViewHolder> {
    private List<RecordData> mDates;
    private Context mContext;
    private GridLayoutManager mGridLayoutManager;

    public CooperationAdapter(int layoutResId, List<RecordData> dataList, Context context) {

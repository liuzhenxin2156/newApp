package com.example.newapp.activity.vip.apply_invoice;
...
public class ApplyInvoiceActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void initViews() {
        ...
        applyInvoiceAdapter = new ApplyInvoiceAdapter(R.layout.gangtie_item, recordDataList,this);
        ...
        applyInvoiceAdapter.refreshDataList(recordDataList);
        applyInvoiceAdapter.setOnItemClickListener(new BaseRecyclerViewAdapter.OnItemClickListener() {
            @Override

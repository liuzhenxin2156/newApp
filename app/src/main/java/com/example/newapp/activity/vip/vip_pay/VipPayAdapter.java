...
public class VipPayAdapter extends BaseRecyclerViewAdapter<RecordData, BaseRecyclerViewHolder> {
    private List<RecordData> mDates;
    private Context mContext;
    private GridLayoutManager mGridLayoutManager;

    public VipPayAdapter(int layoutResId, List<RecordData> dataList, Context context) {

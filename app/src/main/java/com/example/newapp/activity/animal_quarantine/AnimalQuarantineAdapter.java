...
public class AnimalQuarantineAdapter extends BaseRecyclerViewAdapter<RecordData, BaseRecyclerViewHolder> {
    private List<RecordData> mDates;
    private Context mContext;
    private GridLayoutManager mGridLayoutManager;

    public AnimalQuarantineAdapter(int layoutResId, List<RecordData> dataList, Context context) {

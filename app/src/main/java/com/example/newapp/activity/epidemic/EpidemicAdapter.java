...
public class EpidemicAdapter extends BaseRecyclerViewAdapter<RecordData, BaseRecyclerViewHolder> {
    private List<RecordData> mDates;
    private Context mContext;
    private GridLayoutManager mGridLayoutManager;

    public EpidemicAdapter(int layoutResId, List<RecordData> dataList, Context context) {

package com.example.newapp.activity.financial_services.adapter;
...
public class FinancialServicesAdapter  extends BaseRecyclerViewAdapter<RecordData, BaseRecyclerViewHolder> {
    private List<RecordData> mDates;
    private Context mContext;
    private GridLayoutManager mGridLayoutManager;

    public FinancialServicesAdapter(int layoutResId, List<RecordData> dataList, Context context) {

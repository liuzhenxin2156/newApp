package com.example.newapp.activity.vip.vip_pay;
...
public class VipPayActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void initViews() {
        ...
        vipPayAdapter = new VipPayAdapter(R.layout.gangtie_item, recordDataList,this);
        ...
        vipPayAdapter.refreshDataList(recordDataList);
        vipPayAdapter.setOnItemClickListener(new BaseRecyclerViewAdapter.OnItemClickListener() {
            @Override

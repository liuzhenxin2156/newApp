package com.example.newapp.activity.pig_trade;
...
public class PigTradeActivity extends BaseActivity implements View.OnClickListener {
    private TextView mBackTv;
    private RecyclerView recyclerView;
    private PigTradeAdapter pigTradeAdapter;
    ...
    public static void start(Context context) {
        Intent intent = new Intent(context, PigTradeActivity.class);
        context.startActivity(intent);
    }

    @Override
    protected int getContentViewId() {
        return R.layout.activity_pig_trade;
    }
    ...
    protected void initViews() {
        ...
        pigTradeAdapter = new PigTradeAdapter(R.layout.gangtie_item, recordDataList,this);
        ...
        recyclerView.setAdapter(pigTradeAdapter);
        pigTradeAdapter.refreshDataList(recordDataList);
        pigTradeAdapter.setOnItemClickListener(new BaseRecyclerViewAdapter.OnItemClickListener() {
            @Override
    ...
    private void addData(){
        ...
        String [] strings = {"种猪进口"," 精液进口"," 白条进口","分类进口","报关服务","海外对接"
        ,"海外考察","政策咨询"};

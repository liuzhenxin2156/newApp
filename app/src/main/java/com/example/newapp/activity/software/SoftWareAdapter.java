...
public class SoftWareAdapter extends BaseRecyclerViewAdapter<RecordData, BaseRecyclerViewHolder> {
    private List<RecordData> mDates;
    private Context mContext;
    private GridLayoutManager mGridLayoutManager;

    public SoftWareAdapter(int layoutResId, List<RecordData> dataList, Context context) {

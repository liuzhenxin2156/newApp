...
public class CrowdfundingPigAdapter extends BaseRecyclerViewAdapter<RecordData, BaseRecyclerViewHolder> {
    private List<RecordData> mDates;
    private Context mContext;
    private GridLayoutManager mGridLayoutManager;

    public CrowdfundingPigAdapter(int layoutResId, List<RecordData> dataList, Context context) {

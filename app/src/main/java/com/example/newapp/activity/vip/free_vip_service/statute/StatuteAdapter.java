package com.example.newapp.activity.vip.free_vip_service.statute;
...
public class StatuteAdapter extends BaseRecyclerViewAdapter<RecordData, BaseRecyclerViewHolder> {
    private List<RecordData> mDates;
    private Context mContext;
    private GridLayoutManager mGridLayoutManager;

    public StatuteAdapter(int layoutResId, List<RecordData> dataList, Context context) {

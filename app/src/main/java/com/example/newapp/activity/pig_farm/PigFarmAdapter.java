...
public class PigFarmAdapter extends BaseRecyclerViewAdapter<RecordData, BaseRecyclerViewHolder> {
    private List<RecordData> mDates;
    private Context mContext;
    private GridLayoutManager mGridLayoutManager;

    public PigFarmAdapter(int layoutResId, List<RecordData> dataList, Context context) {

...
public class EndDockingAdapter extends BaseRecyclerViewAdapter<RecordData, BaseRecyclerViewHolder> {
    private List<RecordData> mDates;
    private Context mContext;
    private GridLayoutManager mGridLayoutManager;

    public EndDockingAdapter(int layoutResId, List<RecordData> dataList, Context context) {

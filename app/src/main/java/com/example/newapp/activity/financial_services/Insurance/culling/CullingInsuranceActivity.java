package com.example.newapp.activity.financial_services.Insurance.culling;
 ...
 * @author 56454
 */
public class CullingInsuranceActivity extends BaseActivity implements View.OnClickListener {
    ...
    public static void start(Context context, int type) {
        Intent intent = new Intent(context, CullingInsuranceActivity.class);
    ...
    protected int getContentViewId() {
        return R.layout.activity_culling_insurance;
    }
    ...
    protected void initViews() {
        ...
        quanlian_detalis_btn  =findViewById(R.id.quanlian_detalis_btn);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.back_tv:
                ...
                break;
            case R.id.quanlian_insurance_ll://运输险简介
                CullingInsuranceDetailsActivity.start(this,1);
                break;
            case R.id.quanlian_detalis_btn://运输险简介
                CullingInsuranceDetailsActivity.start(this,1);
                break;
            case R.id.quanlian_insurance_btn://运输险投保
    ...
    private void showMorePopWindow() {
        ...
        popupWindow.setOnDismissListener(new PopupWindow.OnDismissListener() {
            ...
            public void onDismiss() {
                PhoneUtil.setBackgroundAlpha(CullingInsuranceActivity.this, 1.0f);
            }
        });

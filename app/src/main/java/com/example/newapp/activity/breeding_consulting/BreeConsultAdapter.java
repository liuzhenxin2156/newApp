...
public class BreeConsultAdapter extends BaseRecyclerViewAdapter<RecordData, BaseRecyclerViewHolder> {
    private List<RecordData> mDates;
    private Context mContext;
    private GridLayoutManager mGridLayoutManager;

    public BreeConsultAdapter(int layoutResId, List<RecordData> dataList, Context context) {

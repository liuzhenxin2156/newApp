...
public class PigDataReportAdapter extends BaseRecyclerViewAdapter<RecordData, BaseRecyclerViewHolder> {
    private List<RecordData> mDates;
    private Context mContext;
    private GridLayoutManager mGridLayoutManager;

    public PigDataReportAdapter(int layoutResId, List<RecordData> dataList, Context context) {

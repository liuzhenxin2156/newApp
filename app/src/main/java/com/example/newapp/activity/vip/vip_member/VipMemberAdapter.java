...
public class VipMemberAdapter extends BaseRecyclerViewAdapter<RecordData, BaseRecyclerViewHolder> {
    private List<RecordData> mDates;
    private Context mContext;
    private GridLayoutManager mGridLayoutManager;

    public VipMemberAdapter(int layoutResId, List<RecordData> dataList, Context context) {

package com.example.newapp.activity.vip.toll_vip_service;
 ...
 * 收费会员服务
 */
public class TollVipServiceActivity extends BaseActivity implements View.OnClickListener {
    private TextView mBackTv;
    private RecyclerView recyclerView;
    private TextView back_level_tv;
    private TollVipServiceAdapter tollVipServiceAdapter;
    ...
    public static void start(Context context) {
        Intent intent = new Intent(context, TollVipServiceActivity.class);
        context.startActivity(intent);
    }

    @Override
    protected int getContentViewId() {
        return R.layout.activity_toll_vip_service;
    }
    ...
    protected void initViews() {
        ...
        tollVipServiceAdapter = new TollVipServiceAdapter(R.layout.gangtie_item, recordDataList,this);
        ...
        recyclerView.setAdapter(tollVipServiceAdapter);
        tollVipServiceAdapter.refreshDataList(recordDataList);
        tollVipServiceAdapter.setOnItemClickListener(new BaseRecyclerViewAdapter.OnItemClickListener() {
            @Override

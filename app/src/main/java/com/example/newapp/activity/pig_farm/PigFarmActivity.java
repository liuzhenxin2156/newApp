package com.example.newapp.activity.pig_farm;
...
public class PigFarmActivity extends BaseActivity implements View.OnClickListener {
    ...
    public static void start(Context context) {
        Intent intent = new Intent(context, PigFarmActivity.class);
        context.startActivity(intent);
    }

    @Override
    protected int getContentViewId() {
        return R.layout.activity_pig_farm;
    }
    ...
    private void addData(){
        ...
        String [] strings = {"猪厂设计","数字猪场","猪厂施工","猪场监理","盖楼养猪"};

...
public class BulkTradeAdapter extends BaseRecyclerViewAdapter<RecordData, BaseRecyclerViewHolder> {
    private List<RecordData> mDates;
    private Context mContext;
    private GridLayoutManager mGridLayoutManager;

    public BulkTradeAdapter(int layoutResId, List<RecordData> dataList, Context context) {

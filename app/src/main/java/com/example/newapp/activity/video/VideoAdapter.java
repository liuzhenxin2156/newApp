...
public class VideoAdapter extends BaseRecyclerViewAdapter<RecordData, BaseRecyclerViewHolder> {
    private List<RecordData> mDates;
    private Context mContext;
    private GridLayoutManager mGridLayoutManager;

    public VideoAdapter(int layoutResId, List<RecordData> dataList, Context context) {

...
public class PigTeachAdapter extends BaseRecyclerViewAdapter<RecordData, BaseRecyclerViewHolder> {
    private List<RecordData> mDates;
    private Context mContext;
    private GridLayoutManager mGridLayoutManager;

    public PigTeachAdapter(int layoutResId, List<RecordData> dataList, Context context) {

...
public class RecruitmentAdapter extends BaseRecyclerViewAdapter<RecordData, BaseRecyclerViewHolder> {
    private List<RecordData> mDates;
    private Context mContext;
    private GridLayoutManager mGridLayoutManager;

    public RecruitmentAdapter(int layoutResId, List<RecordData> dataList, Context context) {

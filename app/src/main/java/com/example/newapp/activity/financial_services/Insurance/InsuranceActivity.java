package com.example.newapp.activity.financial_services.Insurance;
...
import com.example.newapp.activity.financial_services.Insurance.farming.FarmingInsuranceActivity;
...
public class InsuranceActivity extends BaseActivity {
    ...
    protected void initViews() {
        ...
        financialServicesAdapter.setOnItemClickListener(new BaseRecyclerViewAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, BaseRecyclerViewHolder viewHolder, int position) {
                switch (position){
                    case 0://养殖险
                        FarmingInsuranceActivity.start(InsuranceActivity.this,typeID);
                        break;
                    case 1://运输险
                        TransportInsuranceActivity.start(InsuranceActivity.this,typeID);
                        break;
                    case 2://扑杀险
                        CullingInsuranceActivity.start(InsuranceActivity.this,typeID);
                        break;
                    case 3://价格险
                        break;
    ...
    private void addData(){
        ...
        String [] strings = {"养殖险","运输险","扑杀险","价格险","质量险","危害险"};

 ...
 * 会员积分
 */
public class RefundLogOutActivity extends BaseActivity implements View.OnClickListener {
    private TextView mBackTv;
    private RecyclerView recyclerView;
    private TextView back_level_tv;
    private RefundLogoutAdapter refundLogoutAdapter;
    ...
    public static void start(Context context) {
        Intent intent = new Intent(context, RefundLogOutActivity.class);
        context.startActivity(intent);
    }

    @Override
    protected int getContentViewId() {
        return R.layout.activity_refund_logout;
    }
    ...
    protected void initViews() {
        ...
        refundLogoutAdapter = new RefundLogoutAdapter(R.layout.gangtie_item, recordDataList,this);
        ...
        recyclerView.setAdapter(refundLogoutAdapter);
        refundLogoutAdapter.refreshDataList(recordDataList);
        refundLogoutAdapter.setOnItemClickListener(new BaseRecyclerViewAdapter.OnItemClickListener() {
            @Override

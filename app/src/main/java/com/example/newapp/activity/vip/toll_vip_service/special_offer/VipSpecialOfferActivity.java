package com.example.newapp.activity.vip.toll_vip_service.special_offer;
...
public class VipSpecialOfferActivity extends BaseActivity implements View.OnClickListener {
    private TextView mBackTv;
    private RecyclerView recyclerView;
    private TextView back_level_tv;
    private TextView  back_level_tv_one;
    private VipSpecialOfferAdapter vipSpecialOfferAdapter;
    ...
    public static void start(Context context) {
        Intent intent = new Intent(context, VipSpecialOfferActivity.class);
    ...
    protected void initViews() {
        ...
        vipSpecialOfferAdapter = new VipSpecialOfferAdapter(R.layout.gangtie_item, recordDataList,this);
        ...
        recyclerView.setAdapter(vipSpecialOfferAdapter);
        vipSpecialOfferAdapter.refreshDataList(recordDataList);
        vipSpecialOfferAdapter.setOnItemClickListener(new BaseRecyclerViewAdapter.OnItemClickListener() {
            @Override
    ...
    private void showMorePopWindow() {
        ...
        popupWindow.setOnDismissListener(new PopupWindow.OnDismissListener() {
            ...
            public void onDismiss() {
                PhoneUtil.setBackgroundAlpha(VipSpecialOfferActivity.this, 1.0f);
            }
        });

 ...
 * @author 56454
 */
public class CullingInsuranceDetailsActivity extends BaseActivity implements View.OnClickListener {
    ...
    public static void start(Context context, int type) {
        Intent intent = new Intent(context, CullingInsuranceDetailsActivity.class);
    ...
    protected int getContentViewId() {
        return R.layout.activity_culling_insurance_details;
    }

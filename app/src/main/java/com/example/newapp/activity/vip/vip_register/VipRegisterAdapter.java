...
public class VipRegisterAdapter extends BaseRecyclerViewAdapter<RecordData, BaseRecyclerViewHolder> {
    private List<RecordData> mDates;
    private Context mContext;
    private GridLayoutManager mGridLayoutManager;

    public VipRegisterAdapter(int layoutResId, List<RecordData> dataList, Context context) {

package com.example.newapp.activity.software;
...
public class SoftWareActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void initViews() {
        ...
        mBackTv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                finish();
                AppManager.getInstance().finishActivity(SmartPigActivity.class);
            }
        });
        ...
        softWareAdapter = new SoftWareAdapter(R.layout.gangtie_item, recordDataList,this);
        ...
        softWareAdapter.refreshDataList(recordDataList);
        softWareAdapter.setOnItemClickListener(new BaseRecyclerViewAdapter.OnItemClickListener() {
            @Override
    ...
    private void addData(){
        ...
        String [] strings = {"管理类","监管类","营销类","生产类",
                "网站建设","公号运营","视频号运营"," 数字猪场"};

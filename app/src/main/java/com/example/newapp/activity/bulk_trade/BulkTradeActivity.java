package com.example.newapp.activity.bulk_trade;
...
public class BulkTradeActivity extends BaseActivity implements View.OnClickListener {
    private TextView mBackTv;
    private RecyclerView recyclerView;
    private BulkTradeAdapter bulkTradeAdapter;
    ...
    public static void start(Context context) {
        Intent intent = new Intent(context, BulkTradeActivity.class);
        context.startActivity(intent);
    }

    @Override
    protected int getContentViewId() {
        return R.layout.activity_bulk_trade;
    }
    ...
    protected void initViews() {
        ...
        bulkTradeAdapter = new BulkTradeAdapter(R.layout.gangtie_item, recordDataList,this);
        ...
        recyclerView.setAdapter(bulkTradeAdapter);
        bulkTradeAdapter.refreshDataList(recordDataList);
        bulkTradeAdapter.setOnItemClickListener(new BaseRecyclerViewAdapter.OnItemClickListener() {
            @Override

...
public class FreeVipServiceAdapter extends BaseRecyclerViewAdapter<RecordData, BaseRecyclerViewHolder> {
    private List<RecordData> mDates;
    private Context mContext;
    private GridLayoutManager mGridLayoutManager;

    public FreeVipServiceAdapter(int layoutResId, List<RecordData> dataList, Context context) {

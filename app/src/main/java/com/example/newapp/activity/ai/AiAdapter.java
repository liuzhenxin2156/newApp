...
public class AiAdapter extends BaseRecyclerViewAdapter<RecordData, BaseRecyclerViewHolder> {
    private List<RecordData> mDates;
    private Context mContext;
    private GridLayoutManager mGridLayoutManager;

    public AiAdapter(int layoutResId, List<RecordData> dataList, Context context) {

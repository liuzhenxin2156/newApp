package com.example.newapp.activity.pig_pet;
...
public class PigPetActivity extends BaseActivity implements View.OnClickListener {
    ...
    public static void start(Context context) {
        Intent intent = new Intent(context, PigPetActivity.class);
        context.startActivity(intent);
    }

    @Override
    protected int getContentViewId() {
        return R.layout.activity_pig_pet;
    }
    ...
    private void addData(){
        ...
        String [] strings = {"订购"," 咨询"," 服务","用品","检疫","防疫","云游"};

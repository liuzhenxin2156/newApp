package com.example.newapp.activity.animal_protection_products;
...
import com.example.newapp.activity.means_production.MeansProductionAdapter;
...
public class AnimalProtectionActivity extends BaseActivity implements View.OnClickListener {
    ...
    public static void start(Context context) {
        Intent intent = new Intent(context, AnimalProtectionActivity.class);
        context.startActivity(intent);
    }

    @Override
    protected int getContentViewId() {
        return R.layout.activity_animal_protection;
    }

...
public class OldFashionedAdapter extends BaseRecyclerViewAdapter<RecordData, BaseRecyclerViewHolder> {
    private List<RecordData> mDates;
    private Context mContext;
    private GridLayoutManager mGridLayoutManager;

    public OldFashionedAdapter(int layoutResId, List<RecordData> dataList, Context context) {

package com.example.newapp.activity.pig_food;
...
public class PigFoodActivity extends BaseActivity implements View.OnClickListener {
    private TextView mBackTv;
    private RecyclerView recyclerView;
    private PigFoodAdapter pigFoodAdapter;
    ...
    public static void start(Context context) {
        Intent intent = new Intent(context, PigFoodActivity.class);
        context.startActivity(intent);
    }

    @Override
    protected int getContentViewId() {
        return R.layout.activity_pig_food;
    }
    ...
    protected void initViews() {
        ...
        pigFoodAdapter = new PigFoodAdapter(R.layout.gangtie_item, recordDataList,this);
        ...
        recyclerView.setAdapter(pigFoodAdapter);
        pigFoodAdapter.refreshDataList(recordDataList);
        pigFoodAdapter.setOnItemClickListener(new BaseRecyclerViewAdapter.OnItemClickListener() {
            @Override
    ...
    private void addData(){
        ...
        String [] strings = {"教槽料"," 仔猪料"," 中猪料","大猪料","种猪料","预混料","母猪料"};

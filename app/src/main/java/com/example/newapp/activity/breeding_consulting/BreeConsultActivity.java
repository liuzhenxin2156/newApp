package com.example.newapp.activity.breeding_consulting;
...
public class BreeConsultActivity extends BaseActivity implements View.OnClickListener {
    private TextView mBackTv;
    private RecyclerView recyclerView;
    private BreeConsultAdapter breeConsultAdapter;
    ...
    public static void start(Context context) {
        Intent intent = new Intent(context, BreeConsultActivity.class);
        context.startActivity(intent);
    }

    @Override
    protected int getContentViewId() {
        return R.layout.activity_bree_consult;
    }
    ...
    protected void initViews() {
        ...
        breeConsultAdapter = new BreeConsultAdapter(R.layout.gangtie_item, recordDataList,this);
        ...
        recyclerView.setAdapter(breeConsultAdapter);
        breeConsultAdapter.refreshDataList(recordDataList);
        breeConsultAdapter.setOnItemClickListener(new BaseRecyclerViewAdapter.OnItemClickListener() {
            @Override
    ...
    private void addData(){
        ...
        String [] strings = {"仔猪养殖","母猪养殖","种猪养殖","生猪养殖","远程诊断"};

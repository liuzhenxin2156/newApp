...
public class SmartPigAdapter extends BaseRecyclerViewAdapter<RecordData, BaseRecyclerViewHolder> {
    private List<RecordData> mDates;
    private Context mContext;
    private GridLayoutManager mGridLayoutManager;

    public SmartPigAdapter(int layoutResId, List<RecordData> dataList, Context context) {

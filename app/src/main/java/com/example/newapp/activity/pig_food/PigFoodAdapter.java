...
public class PigFoodAdapter extends BaseRecyclerViewAdapter<RecordData, BaseRecyclerViewHolder> {
    private List<RecordData> mDates;
    private Context mContext;
    private GridLayoutManager mGridLayoutManager;

    public PigFoodAdapter(int layoutResId, List<RecordData> dataList, Context context) {

...
public class MeansProductionAdapter extends BaseRecyclerViewAdapter<RecordData, BaseRecyclerViewHolder> {
    private List<RecordData> mDates;
    private Context mContext;
    private GridLayoutManager mGridLayoutManager;

    public MeansProductionAdapter(int layoutResId, List<RecordData> dataList, Context context) {

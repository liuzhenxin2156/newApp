package com.example.newapp.activity.quarantine;
...
public class QuarantineActivity extends BaseActivity implements View.OnClickListener {
    ...
    public static void start(Context context) {
        Intent intent = new Intent(context, QuarantineActivity.class);
    ...
    protected void initViews() {
        ...
        mBackTv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                finish();
                AppManager.getInstance().finishActivity(AniamlQuarantineActivity.class);
            }
        });
    ...
    private void addData(){
        ...
        String [] strings = {"检疫申报","临床检查","自助检疫","自动检疫"};

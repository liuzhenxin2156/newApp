...
public class PigIndustryAdapter extends BaseRecyclerViewAdapter<RecordData, BaseRecyclerViewHolder> {
    private List<RecordData> mDates;
    private Context mContext;
    private GridLayoutManager mGridLayoutManager;

    public PigIndustryAdapter(int layoutResId, List<RecordData> dataList, Context context) {

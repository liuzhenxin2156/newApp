package com.example.newapp.activity.vip.special_pay_service.enddocking;
 ...
 * 终端对接
 */
public class EndDockingActivity extends BaseActivity implements View.OnClickListener {
    private TextView mBackTv;
    private RecyclerView recyclerView;
    private TextView back_level_tv;
    private TextView back_level_tv_one;
    private EndDockingAdapter endDockingAdapter;
    ...
    public static void start(Context context) {
        Intent intent = new Intent(context, EndDockingActivity.class);
        context.startActivity(intent);
    }

    @Override
    protected int getContentViewId() {
        return R.layout.activity_end_docking;
    }
    ...
    protected void initViews() {
        ...
        endDockingAdapter = new EndDockingAdapter(R.layout.gangtie_item, recordDataList, this);
        ...
        recyclerView.setAdapter(endDockingAdapter);
        endDockingAdapter.refreshDataList(recordDataList);
        endDockingAdapter.setOnItemClickListener(new BaseRecyclerViewAdapter.OnItemClickListener() {
            @Override
    ...
    private void showMorePopWindow() {
        ...
        popupWindow.setOnDismissListener(new PopupWindow.OnDismissListener() {
            ...
            public void onDismiss() {
                PhoneUtil.setBackgroundAlpha(EndDockingActivity.this, 1.0f);
            }
        });

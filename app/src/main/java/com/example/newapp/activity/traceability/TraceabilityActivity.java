package com.example.newapp.activity.traceability;
...
public class TraceabilityActivity extends BaseActivity implements View.OnClickListener {
    ...
    public static void start(Context context) {
        Intent intent = new Intent(context, TraceabilityActivity.class);
    ...
    protected void initViews() {
        ...
        traceabilityAdapter.refreshDataList(recordDataList);
        traceabilityAdapter.setOnItemClickListener(new BaseRecyclerViewAdapter.OnItemClickListener() {
            @Override
    ...
    private void addData(){
        ...
        String [] strings = {"  标准制定","  溯源监管"," 信息发布","品牌宣传"};

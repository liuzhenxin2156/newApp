...
public class VipServiceAdapter extends BaseRecyclerViewAdapter<RecordData, BaseRecyclerViewHolder> {
    private List<RecordData> mDates;
    private Context mContext;
    private GridLayoutManager mGridLayoutManager;

    public VipServiceAdapter(int layoutResId, List<RecordData> dataList, Context context) {

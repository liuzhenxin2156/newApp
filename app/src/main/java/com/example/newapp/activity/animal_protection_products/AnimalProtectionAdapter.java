...
public class AnimalProtectionAdapter extends BaseRecyclerViewAdapter<RecordData, BaseRecyclerViewHolder> {
    private List<RecordData> mDates;
    private Context mContext;
    private GridLayoutManager mGridLayoutManager;

    public AnimalProtectionAdapter(int layoutResId, List<RecordData> dataList, Context context) {

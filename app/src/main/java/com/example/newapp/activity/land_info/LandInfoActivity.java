package com.example.newapp.activity.land_info;
...
public class LandInfoActivity extends BaseActivity implements View.OnClickListener {
    ...
    public static void start(Context context) {
        Intent intent = new Intent(context, LandInfoActivity.class);
    ...
    protected void initViews() {
        ...
        landInfoAdapter = new LandInfoAdapter(R.layout.gangtie_item, recordDataList,this);
        ...
        recyclerView.setAdapter(landInfoAdapter);
        landInfoAdapter.refreshDataList(recordDataList);
        landInfoAdapter.setOnItemClickListener(new BaseRecyclerViewAdapter.OnItemClickListener() {
            @Override
    ...
    private void addData(){
        ...
        String [] strings = {"可用土地信息","土地手续办理"," 法律手续代办"," 土地转让信息"," 土地流转对接"
        };

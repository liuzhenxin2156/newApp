...
public class PigOnlineAdapter extends BaseRecyclerViewAdapter<RecordData, BaseRecyclerViewHolder> {
    private List<RecordData> mDates;
    private Context mContext;
    private GridLayoutManager mGridLayoutManager;

    public PigOnlineAdapter(int layoutResId, List<RecordData> dataList, Context context) {

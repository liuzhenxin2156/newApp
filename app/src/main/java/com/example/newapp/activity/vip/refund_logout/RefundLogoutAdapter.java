package com.example.newapp.activity.vip.refund_logout;
...
public class RefundLogoutAdapter extends BaseRecyclerViewAdapter<RecordData, BaseRecyclerViewHolder> {
    private List<RecordData> mDates;
    private Context mContext;
    private GridLayoutManager mGridLayoutManager;

    public RefundLogoutAdapter(int layoutResId, List<RecordData> dataList, Context context) {

package com.example.newapp.activity.vip.vip_member;
...
import com.example.newapp.activity.vip.vip_register.VipRegisterAdapter;
...
public class VipMemberActivity extends BaseActivity implements View.OnClickListener {
    ...
    public static void start(Context context) {
        Intent intent = new Intent(context, VipMemberActivity.class);
    ...
    protected void initViews() {
        ...
        vipMemberAdapter = new VipMemberAdapter(R.layout.gangtie_item, recordDataList,this);
        ...
        vipMemberAdapter.refreshDataList(recordDataList);
        vipMemberAdapter.setOnItemClickListener(new BaseRecyclerViewAdapter.OnItemClickListener() {
            @Override
    ...
    private void addData(){
        ...
        String [] strings = {"积分获得办法","积分管理办法","积分过期办法","积分转让办法","积分用途","积分商场"};

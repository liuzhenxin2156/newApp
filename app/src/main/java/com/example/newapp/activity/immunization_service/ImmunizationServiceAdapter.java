...
public class ImmunizationServiceAdapter extends BaseRecyclerViewAdapter<RecordData, BaseRecyclerViewHolder> {
    private List<RecordData> mDates;
    private Context mContext;
    private GridLayoutManager mGridLayoutManager;

    public ImmunizationServiceAdapter(int layoutResId, List<RecordData> dataList, Context context) {

package com.example.newapp.activity.video;
...
public class VideoActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void initViews() {
        ...
        videoAdapter = new VideoAdapter(R.layout.gangtie_item, recordDataList,this);
        ...
        videoAdapter.refreshDataList(recordDataList);
        videoAdapter.setOnItemClickListener(new BaseRecyclerViewAdapter.OnItemClickListener() {
            @Override

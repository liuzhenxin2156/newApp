...
public class QuarantineAdapter extends BaseRecyclerViewAdapter<RecordData, BaseRecyclerViewHolder> {
    private List<RecordData> mDates;
    private Context mContext;
    private GridLayoutManager mGridLayoutManager;

    public QuarantineAdapter(int layoutResId, List<RecordData> dataList, Context context) {

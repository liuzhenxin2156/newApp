package com.example.newapp.activity.pig_teach;
...
import com.example.newapp.activity.pig_trade.PigTradeAdapter;
...
public class PigTeachActivity extends BaseActivity implements View.OnClickListener {
    private TextView mBackTv;
    private RecyclerView recyclerView;
    private PigTeachAdapter pigTeachAdapter;
    ...
    public static void start(Context context) {
        Intent intent = new Intent(context, PigTeachActivity.class);
        context.startActivity(intent);
    }

    @Override
    protected int getContentViewId() {
        return R.layout.activity_pig_teach;
    }
    ...
    protected void initViews() {
        ...
        pigTeachAdapter = new PigTeachAdapter(R.layout.gangtie_item, recordDataList,this);
        ...
        recyclerView.setAdapter(pigTeachAdapter);
        pigTeachAdapter.refreshDataList(recordDataList);
        pigTeachAdapter.setOnItemClickListener(new BaseRecyclerViewAdapter.OnItemClickListener() {
            @Override
    ...
    private void addData(){
        ...
        String [] strings = {"本科教育"," 专科教育"," 专升本","执业兽医","定向培养","特约培训"
        ,"应急辅导"};

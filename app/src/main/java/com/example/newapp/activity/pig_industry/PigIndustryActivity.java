package com.example.newapp.activity.pig_industry;
...
public class PigIndustryActivity extends BaseActivity implements View.OnClickListener {
    private TextView mBackTv;
    private RecyclerView recyclerView;
    private PigIndustryAdapter pigIndustryAdapter;
    ...
    public static void start(Context context) {
        Intent intent = new Intent(context, PigIndustryActivity.class);
        context.startActivity(intent);
    }

    @Override
    protected int getContentViewId() {
        return R.layout.activity_pig_industry;
    }
    ...
    protected void initViews() {
        ...
        pigIndustryAdapter = new PigIndustryAdapter(R.layout.gangtie_item, recordDataList,this);
        ...
        recyclerView.setAdapter(pigIndustryAdapter);
        pigIndustryAdapter.refreshDataList(recordDataList);
        pigIndustryAdapter.setOnItemClickListener(new BaseRecyclerViewAdapter.OnItemClickListener() {
            @Override
    ...
    private void addData(){
        ...
        String [] strings = {"猪皮"," 猪鬃"," 猪毛","肠衣","进出口"};
